...
label_cheetah.grid(row=0, column=1, columnspan=3) #Cheetah/PMO Data
label_PM_Entry.grid(row=0, column=4) #PM Entry
label_market.grid(row=1, column=0) #Per Market
label_complete1.grid(row=1, column=2) #Complete
label_total1.grid(row=1, column=3) #Total
label_complete.grid(row=1, column=4)
...
label_psc.grid(row=3, column=0, sticky="ew")
#psc_instructions.grid(row=3, column=7, sticky="ew")
psc_complete.grid(row=3, column=4)
psc_total.grid(row=3, column=5)
psc_notes.grid(row=3, column=6)
psc_cheetah_complete.grid(row=3, column=2)
psc_cheetah_total.grid(row=3, column=3)
...
label_neat.grid(row=4, column=0, sticky="ew")
#neat_instructions.grid(row=4, column=7, sticky="ew")
neat_complete.grid(row=4, column=4)
neat_total.grid(row=4, column=5)
neat_notes.grid(row=4, column=6)
neat_cheetah_complete.grid(row=4, column=2)
neat_cheetah_total.grid(row=4, column=3)
...
label_fiber.grid(row=5, column=0, sticky="ew")
#fiber_instructions.grid(row=5, column=7, sticky="ew")
fiber_Complete.grid(row=5, column=4)
fiber_total.grid(row=5, column=5)
fiber_notes.grid(row=5, column=6)
fiber_cheetah_complete.grid(row=5, column=2)
fiber_cheetah_total.grid(row=5, column=3)
...
label_om96.grid(row=6, column=0, sticky="ew")
#om96_instructions.grid(row=6, column=7, sticky="ew")
om96_complete.grid(row=6, column=4)
om96_total.grid(row=6, column=5)
om96_notes.grid(row=6, column=6)
om96_cheetah_complete.grid(row=6, column=2)
om96_cheetah_total.grid(row=6, column=3)
...
label_kpi_Nat.grid(row=7, column=0, sticky="ew")
#kpi_Nat_instructions.grid(row=7, column=7, sticky="ew")
kpi_Nat_Complete.grid(row=7, column=4)
kpi_Nat_total.grid(row=7, column=5)
kpi_Nat_notes.grid(row=7, column=6)
kpi_cheetah_complete.grid(row=7, column=2)
kpi_cheetah_total.grid(row=7, column=3)
...
label_10G_BH_A.grid(row=8, column=0, sticky="ew")
#E_10G_BH_A_instructions.grid(row=8, column=7, sticky="ew")
E_10G_BH_A_Complete.grid(row=8, column=4)
E_10G_BH_A_total.grid(row=8, column=5)
E_10G_BH_A_notes.grid(row=8, column=6)
E_10G_BH_A_cheetah_complete.grid(row=8, column=2)
E_10G_BH_A_cheetah_total.grid(row=8, column=3)
...
label_10G_BH_B.grid(row=9, column=0, sticky="ew")
#E_10G_BH_B_instructions.grid(row=9, column=7, sticky="ew")
E_10G_BH_B_Complete.grid(row=9, column=4)
E_10G_BH_B_total.grid(row=9, column=5)
E_10G_BH_B_notes.grid(row=9, column=6)
E_10G_BH_B_cheetah_complete.grid(row=9, column=2)
E_10G_BH_B_cheetah_total.grid(row=9, column=3)
...
label_consumption.grid(row=10, column=0, sticky="ew")
#consumption_instructions.grid(row=10, column=7, sticky="ew")
consumption_Complete.grid(row=10, column=4)
consumption_total.grid(row=10, column=5)
consumption_notes.grid(row=10, column=6)
consumption_cheetah_complete.grid(row=10, column=2)
consumption_cheetah_total.grid(row=10, column=3)
...
label_fiber_loops.grid(row=11, column=0, sticky="ew")
#fiber_loops_instructions.grid(row=11, column=7, sticky="ew")
fiber_loops_Complete.grid(row=11, column=4)
fiber_loops_total.grid(row=11, column=5)
fiber_loops_notes.grid(row=11, column=6)
fiber_loops_cheetah_complete.grid(row=11, column=2)
fiber_loops_cheetah_total.grid(row=11, column=3)
...
label_ER_Uplinks.grid(row=12, column=0, sticky="ew")
#ER_Uplinks_instructions.grid(row=12, column=7, sticky="ew")
ER_Uplinks_Complete.grid(row=12, column=4)
ER_Uplinks_total.grid(row=12, column=5)
ER_Uplinks_notes.grid(row=12, column=6)
ER_Uplinks_cheetah_complete.grid(row=12, column=2)
ER_Uplinks_cheetah_total.grid(row=12, column=3)
...
label_IHR.grid(row=13, column=0, sticky="ew")
#IHR_instructions.grid(row=13, column=7, sticky="ew")
IHR_Complete.grid(row=13, column=4)
IHR_total.grid(row=13, column=5)
IHR_notes.grid(row=13, column=6)
IHR_cheetah_complete.grid(row=13, column=2)
IHR_cheetah_total.grid(row=13, column=3)

Pri_5G_CRAN=Label(my_frame2, text="Priority 5G CRAN only", bg="black", fg="white", anchor=CENTER)
Pri_5G_CRAN.grid(row=14, column=0, columnspan=8, sticky="ew")
...
label_P_5G_CRANS.grid(row=15, column=0, sticky="ew")
#P_5G_CRANS_instructions.grid(row=15, column=7, sticky="ew")
P_5G_CRANS_complete.grid(row=15, column=4)
P_5G_CRANS_total.grid(row=15, column=5)
P_5G_CRANS_notes.grid(row=15, column=6)
P_5G_CRANS_cheetah_complete.grid(row=15, column=2)
P_5G_CRANS_cheetah_total.grid(row=15, column=3)
...
label_P_5G_consumption.grid(row=16, column=0, sticky="ew")
#P_5G_consumption_instructions.grid(row=16, column=7, sticky="ew")
P_5G_consumption_Complete.grid(row=16, column=4)
P_5G_consumption_total.grid(row=16, column=5)
P_5G_consumption_notes.grid(row=16, column=6)
P_5G_consumption_cheetah_complete.grid(row=16, column=2)
P_5G_consumption_cheetah_total.grid(row=16, column=3)
...
label_P_5G_Circuits.grid(row=17, column=0, sticky="ew")
#P_5G_Circuits_instructions.grid(row=17, column=7, sticky="ew")
P_5G_Circuits_Complete.grid(row=17, column=4)
P_5G_Circuits_total.grid(row=17, column=5)
P_5G_Circuits_notes.grid(row=17, column=6)
P_5G_Circuits_cheetah_complete.grid(row=17, column=2)
P_5G_Circuits_cheetah_total.grid(row=17, column=3)
...
label_target_Date.grid(row=18, column=0, sticky="ew")
#target_Date_instructions.grid(row=18, column=7, sticky="ew")
target_Date_complete.grid(row=18, column=4)
target_Date_total.grid(row=18, column=5)
target_Date_notes.grid(row=18, column=6)
target_Date_cheetah_complete.grid(row=18, column=2)
target_Date_cheetah_total.grid(row=18, column=3)

label_E_Line=Label(my_frame2, text = "E-Line", bg="black", fg="white", anchor=CENTER)
label_E_Line.grid(row=19, column=0, columnspan=8, sticky="ew")
...
label_MPLS_75.grid(row=20, column=0, sticky="ew")
#MPLS_75_instructions.grid(row=20, column=7)
MPLS_75_Complete.grid(row=20, column=4)
MPLS_75_total.grid(row=20, column=5)
MPLS_75_notes.grid(row=20, column=6)
MPLS_75_cheetah_complete.grid(row=20, column=2)
MPLS_75_cheetah_total.grid(row=20, column=3)
...
label_MPLS_90.grid(row=21, column=0, sticky="ew")
#MPLS_90_instructions.grid(row=21, column=7, sticky="ew")
MPLS_90_Complete.grid(row=21, column=4)
MPLS_90_total.grid(row=21, column=5)
MPLS_90_Notes.grid(row=21, column=6)
MPLS_90_cheetah_complete.grid(row=21, column=2)
MPLS_90_cheetah_total.grid(row=21, column=3)
...
Current_Complete_notes=Entry(my_frame2, width=50)
...
label_Current_Complete.grid(row=22, column=0, sticky="ew")
#Current_Complete_instructions.grid(row=22, column=7, sticky="ew")
Current_Complete_complete.grid(row=22, column=4)
Current_Complete_total.grid(row=22, column=5)
Current_Complete_notes.grid(row=22, column=6)
Current_Complete_cheetah_complete.grid(row=22, column=2)
Current_Complete_cheetah_total.grid(row=22, column=3)
...
label_e_Line_P.grid(row=23, column=0, sticky="ew")
#e_Line_P_instructions.grid(row=23, column=7, sticky="ew")
e_Line_P_complete.grid(row=23, column=4)
e_Line_P_total.grid(row=23, column=5)
e_Line_P_notes.grid(row=23, column=6)
e_Line_P_cheetah_complete.grid(row=23, column=2)
e_Line_P_cheetah_total.grid(row=23, column=3)
...
lable_5G_P.grid(row=24, column=0, sticky="ew")
#e_5G_P_instructions.grid(row=24, column=7, sticky="ew")
e_5g_P_complete.grid(row=24, column=4)
e_5g_P_total.grid(row=24, column=5)
e_5g_P_notes.grid(row=24, column=6)
e_5g_P_cheetah_complete.grid(row=24, column=2)
e_5g_P_cheetah_total.grid(row=24, column=3)

label_UT_Build=Label(my_frame2, text = "UT Build Issues", bg="black", fg="white")
label_E_Line.grid(row=26, column=0, columnspan=1, sticky="ew")
label_External=Label(my_frame2, text = "External Issues Comments (70 char max)", bg="black", fg="white")
label_External.grid(row=26, column=6,sticky="ew")
#label_Example=Label(my_frame2, text = "Example Issues Comments", bg="black", fg="white")
#label_Example.grid(row=26, column=7, sticky="ew")
...
issue1.grid(row=27, column=0, sticky="ew")
issue2.grid(row=28, column=0, sticky="ew")
issue3.grid(row=29, column=0, sticky="ew")
issue4.grid(row=30, column=0, sticky="ew")
issue5.grid(row=31, column=0, sticky="ew")
issue6.grid(row=32, column=0, sticky="ew")
...
comment5 = StringVar()
comment6 = StringVar()
comment1=Entry(my_frame2, width=50)
comment2=Entry(my_frame2, width=50)
comment3=Entry(my_frame2, width=50)
comment4=Entry(my_frame2, width=50)
comment5=Entry(my_frame2, width=50)
comment6=Entry(my_frame2, width=50)
comment1.grid(row=27, column=6)
comment2.grid(row=28, column=6)
comment3.grid(row=29, column=6)
comment4.grid(row=30, column=6)
comment5.grid(row=31, column=6)
comment6.grid(row=32, column=6)
...
submit_btn = Button(my_frame2, text="Add Record to Database", command=menu_command)
submit_btn.grid(row=33, column=0, pady=10, padx=10, ipadx=100)
