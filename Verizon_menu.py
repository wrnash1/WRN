...
psc_notes=Entry(my_frame2, width=50)
...
neat_notes=Entry(my_frame2, width=50)
...
fiber_notes=Entry(my_frame2, width=50)
...
om96_notes=Entry(my_frame2, width=50)
...
kpi_Nat_notes=Entry(my_frame2, width=50)
...
E_10G_BH_A_notes=Entry(my_frame2, width=50)
...
E_10G_BH_B_notes=Entry(my_frame2, width=50)
...
consumption_notes=Entry(my_frame2, width=50)
...
fiber_loops_notes=Entry(my_frame2, width=50)
...
ER_Uplinks_notes=Entry(my_frame2, width=50)
...
IHR_notes=Entry(my_frame2, width=50)
...
P_5G_CRANS_notes=Entry(my_frame2, width=50)
...
P_5G_consumption_notes=Entry(my_frame2, width=50)
...
P_5G_Circuits_notes=Entry(my_frame2, width=50)
...
target_Date_notes=Entry(my_frame2, width=50)
...
MPLS_75_notes=Entry(my_frame2, width=50)
...
MPLS_90_Notes=Entry(my_frame2, width=50)
...
Current_Complete=Entry(my_frame2, width=10)
Current_notes=Entry(my_frame2, width=50)
...
e_Line_P_notes=Entry(my_frame2, width=50)
...
e_5g_P_notes=Entry(my_frame2, width=50)
...
#ttk.Separator(my_frame2,orient=HORIZONTAL).grid(row=2, columnspan=8)
...
label_P_5G_Circuits.grid(row=17, column=1)
label_P_5G_Circuits_instructions.grid(row=17, column=8)
...
Label_target_Date.grid(row=18, column=1)
Label_target_Date_instructions.grid(row=18, column=8)
target_Date_total.grid(row=18, column=6)
target_Date_notes.grid(row=18, column=7)

label_E_Line.grid(row=19, column=1)

label_MPLS_75.grid(row=20, column=1)
label_MPLS_75_instructions.grid(row=20, column=8)
MPLS_75_Complete.grid(row=20, column=6)
MPLS_75_notes.grid(row=20, column=7)

label_MPLS_90.grid(row=21, column=1)
label_MPLS_90_instructions.grid(row=21, column=8)
MPLS_90_Complete.grid(row=21, column=6)
MPLS_90_Notes.grid(row=21, column=7)

label_Current_Complete.grid(row=22, column=1)
label_Current_Complete_instructions.grid(row=22, column=8)
Current_Complete.grid(row=22, column=5)
Current_notes.grid(row=22, column=7)

label_e_Line_P.grid(row=23, column=1)
label_e_Line_P_instructions.grid(row=23, column=8)
e_Line_P_notes.grid(row=23, column=7)

lable_5G_P.grid(row=24, column=1)
lable_5G_P_instructions.grid(row=24, column=8)
